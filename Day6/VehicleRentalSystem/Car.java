...
//Create subclasses Car with specific implementations of calculateRentalCost()
public class Car extends  Vehicle implements Insurable{
    int days;
    int insuranceAmt =5000;
    Car(String vehicleNumber, String type, int rentalRate, int days){
